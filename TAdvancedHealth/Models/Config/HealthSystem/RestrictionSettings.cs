...
namespace Tavstal.TAdvancedHealth.Models.Config.HealthSystem
{
    public class RestrictionSettings
    {
        ...
        [YamlMember(Order = 4, Description = "Allows driving with broken bones status effect")]
        public bool CanDriveWithBrokenBones { get; set; }
        
        [YamlMember(Order = 5, Description = "Allows driving with one broken leg")]
        public bool CanDriveWithOneBrokenLeg { get; set; }
        
        [YamlMember(Order = 6, Description = "Allows driving with both legs broken")]
        public bool CanDriveWithBrokenLegs { get; set; }
        
        [YamlMember(Order = 7, Description = "Allows driving with one broken arm")]
        public bool CanDriveWithOneBrokenArm { get; set; }
        
        [YamlMember(Order = 8, Description = "Allows driving with both arms broken")]
        public bool CanDriveWithBrokenArms { get; set; }
        
        [YamlMember(Order = 9, Description = "Allows holding one-handed items with one broken arm")]
        public bool CanHoldOneHandItemsWithOneBrokenArm { get; set; }
        
        [YamlMember(Order = 10, Description = "Allows holding two-handed items with one broken arm")]
        public bool CanHoldTwoHandItemsWithOneBrokenArm { get; set; }
        
        [YamlMember(Order = 11, Description = "Allows holding one-handed items with both arms broken")]
        public bool CanHoldOneHandItemsWithBrokenArms { get; set; }
        
        [YamlMember(Order = 12, Description = "Allows holding two-handed items with both arms broken")]
        public bool CanHoldTwoHandItemsWithBrokenArms { get; set; }
        
        [YamlMember(Order = 13, Description = "Allows jumping with one broken leg")]
        public bool CanJumpWithOneBrokenLeg { get; set; }
        
        [YamlMember(Order = 14, Description = "Allows jumping with both legs broken")]
